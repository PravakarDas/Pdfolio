...
/* ---------- Starfield + Meteors Canvas (clipped & responsive) ---------- */
function Starfield({
  starCount = 140,
  meteorEveryMs = 2500,
}: {
  ...
  }, [starCount, meteorEveryMs, reduceMotion]);
...
export default function About() {
  return (
    <section
      id="about"
      className="relative overflow-hidden overflow-x-hidden py-20 text-white scroll-mt-24 md:scroll-mt-28"
    >
      {/* Clipped decorative layer to prevent horizontal scroll */}
      <div className="pointer-events-none absolute inset-0 -z-10 overflow-hidden">
        <div className="absolute -top-16 -left-24 h-56 w-56 rounded-full bg-white/10 blur-3xl" />
        <div className="absolute -bottom-28 -right-16 h-64 w-64 rounded-full bg-indigo-300/10 blur-3xl" />
      </div>

      {/* Stars + meteors (also clipped by parent) */}
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="grid items-start gap-10 md:grid-cols-2">
          {/* Left column — profile & contacts (kept) */}
          <motion.div
            initial="hidden"
            whileInView="show"
            viewport={{ once: true, amount: 0.3 }}
          ...
          >
            ...
            <p className="mb-4 text-base leading-7 text-white/90">
              Results-driven Software Developer specializing in full-stack web development and AI integration.
              I design scalable systems, optimize backends, and build user-centric apps that deliver measurable impact.
              Passionate about turning complex problems into efficient, real-world software solutions.
            </p>
            <p className="text-base leading-7 text-white/90">
              Comfortable across the stack—from component systems and data models to DevOps, caching, and cloud deployments.
            </p>
            ...
            <ul className="mt-6 space-y-3">
              <li className="flex items-center gap-3">
                ...
                <span className="text-white/90">Chittagong, Bangladesh</span>
              </li>
              <li className="flex items-center gap-3">
          ...
          {/* Right column — ✅ Core Competencies (unchanged & intact) */}
          <motion.div
            initial="hidden"
            whileInView="show"
            viewport={{ once: true, amount: 0.3 }}
